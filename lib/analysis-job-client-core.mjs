...
export const ANALYSIS_JOB_POLLING_ATTEMPTS = 145;

export function getAnalysisJobPollingDelay(attempt) {
  return Number.isInteger(attempt) && attempt >= 0 && attempt < 5 ? 2000 : 5000;
}
