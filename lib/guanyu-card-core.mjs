...
const READING_VALUES = new Set(['深度阅读', '概览阅读', '有限参考', '材料不足']);
...
const READING_VALUE_ALIASES = new Map([
  ...
  ['有限参考', '有限参考'], ['有限參考', '有限参考'],
  ['材料不足', '材料不足'],
  ['值得细读', '深度阅读'], ['值得閱讀', '深度阅读'], ['值得一读', '深度阅读'],
  ['可以略读', '概览阅读'], ['可以略讀', '概览阅读'], ['略读', '概览阅读'], ['略讀', '概览阅读'],
  ['不值一读', '有限参考'], ['不值一讀', '有限参考'], ['不值得读', '有限参考'], ['不值得讀', '有限参考'],
  ['暂无法判断', '材料不足'], ['暫無法判斷', '材料不足'], ['无法判断', '材料不足'], ['無法判斷', '材料不足'],
  ['worth reading', '深度阅读'], ['read closely', '深度阅读'], ['in-depth reading', '深度阅读'],
  ['skimmable', '概览阅读'], ['can skim', '概览阅读'], ['overview reading', '概览阅读'],
  ['not worth reading', '有限参考'], ['not worth it', '有限参考'], ['limited reference', '有限参考'],
  ['insufficient information', '材料不足'], ['insufficient material', '材料不足'],
  ['精読向け', '深度阅读'], ['概要把握', '概览阅读'], ['限定参考', '有限参考'], ['資料不足', '材料不足'],
  ['심층 읽기', '深度阅读'], ['개요 읽기', '概览阅读'], ['제한적 참고', '有限参考'], ['자료 부족', '材料不足'],
  ['vertiefende lektüre', '深度阅读'], ['überblickslektüre', '概览阅读'], ['begrenzter referenzwert', '有限参考'], ['unzureichende grundlage', '材料不足'],
  ['lettura approfondita', '深度阅读'], ['lettura d’insieme', '概览阅读'], ['riferimento limitato', '有限参考'], ['materiale insufficiente', '材料不足'],
]);
...
function normalizeReadingValue(value) {
  ...
  return READING_VALUE_ALIASES.get(normalized.toLowerCase()) || '材料不足';
}
