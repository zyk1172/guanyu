 ...
 */
export function canClaimAnalyzeJob({ status, nextAttemptAt, leaseExpiresAt, now = new Date() } = {}) {
...
export function shouldScheduleAnalyzeJobRecovery(input = {}) {
  return canClaimAnalyzeJob(input);
}
