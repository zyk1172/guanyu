    ...
    <main className="min-h-screen bg-gray-50 text-gray-950 dark:bg-gray-980 dark:text-white">
      ...
      <section className="mx-auto w-full max-w-7xl px-4 py-6 sm:px-6">
        <div className="mb-4 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h1 className="text-xl font-black sm:text-2xl"><UiText id="publicAudits.title" /></h1>
            <p className="mt-1 text-xs font-semibold text-gray-500 dark:text-gray-400">
              <UiText id="publicAudits.description" />
            </p>
          </div>
            ...
            {audits.map((audit) => (
              <article key={audit.id} className="rounded-xl border border-gray-150 bg-white p-4 shadow-sm transition hover:border-gray-300 dark:border-gray-850 dark:bg-gray-950 dark:hover:border-gray-700">
                <div className="flex flex-wrap items-center gap-1.5 text-xxs font-bold text-gray-400">
                  ...
                  <span>·</span>
                  <span><UiText id="publicAudits.views" values={{ count: audit.viewCount }} /></span>
                </div>
                ...
                <div className="mt-3 flex flex-wrap items-center gap-1.5 text-xxs font-bold">
                  ...
                  <span className="rounded bg-slate-100 px-2 py-0.5 text-slate-700 dark:bg-slate-900 dark:text-slate-300"><UiText id="publicAudits.credibility" values={{ score: audit.credibilityScore }} /></span>
                  <span className="rounded bg-red-50 px-2 py-0.5 text-red-700 dark:bg-red-950/30 dark:text-red-300"><UiText id="publicAudits.risk" values={{ score: audit.speculationRiskScore }} /></span>
                </div>
